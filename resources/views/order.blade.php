...
<ul class="flex">
    ...
    <li class="flex-1 mr-2">
        <a class="text-center block border border-green-500 rounded py-2 px-4 bg-red-500 hover:bg-yellow-500 text-white" href="/">Contact</a>
    </li>
...
<div class="container_order">
    ...
    <form action="{{route('order.store')}}" method="Post">
        ...
        <input name="" type="submit" value="Volgende stap">
    </form>
</div>
</body>
</html>
